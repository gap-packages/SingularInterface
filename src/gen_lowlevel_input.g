...
output := OutputTextFile("lowlevel_mappings_src.g", false);

PrintTo(output, "# DO NOT EDIT THIS FILE BY HAND IT IS MACHINE GENERATED\n");
PrintTo(output, "SINGULAR_funcs := [\n");
